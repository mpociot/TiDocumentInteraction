...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','de.marcelpociot.documentinteraction.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','DeMarcelpociotDocumentinteractionModuleAssets.m')
